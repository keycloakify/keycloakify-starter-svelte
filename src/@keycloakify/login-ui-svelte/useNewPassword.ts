...
import type { PasswordPolicies } from '../login-ui/core/newPasswordApi/index';
import * as coreApi from '../login-ui/core/newPasswordApi/index';
...
export type ParamsOfGetNewPasswordApi = {
  ...
  userProfileApi: Omit<import('../login-ui/core/userProfileApi').UserProfileApi, 'dispatchFormAction'> | undefined;
  i18n: I18nLike;
};
